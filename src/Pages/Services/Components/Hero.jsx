			...
			<div className="my-12 flex flex-col justify-center gap-16 px-5">
				<div className="flex gap-12 rounded-3xl border border-gray-300 p-8 shadow-lg">
					<div className="flex-1 overflow-hidden rounded-3xl">
						<img
							...
							src="https://res.cloudinary.com/dkezwrb3a/image/upload/v1689181151/furniturelo/service/service-1_ppiw2w.svg"
							alt=""
						/>
					</div>
				...
				<div className="flex flex-row-reverse gap-12 rounded-3xl border border-gray-300 p-8 shadow-lg">
					<div className="flex-1 overflow-hidden rounded-3xl">
						<img
							className="w-full object-cover"
							src="https://res.cloudinary.com/dkezwrb3a/image/upload/v1689181150/furniturelo/service/Rectangle_10_zlu16u.svg"
							alt=""
						/>
					</div>
				...
				<div className="flex gap-12 rounded-3xl border border-gray-300 p-8 shadow-lg">
					<div className="flex-1 overflow-hidden rounded-3xl">
						<img
							className="w-full object-cover"
							src="https://res.cloudinary.com/dkezwrb3a/image/upload/v1689181150/furniturelo/service/Rectangle_11_locipc.svg"
							alt=""
						/>
					</div>
				...
				<div className="flex flex-row-reverse gap-12 rounded-3xl border border-gray-300 p-8 shadow-lg">
					<div className="flex-1 overflow-hidden rounded-3xl">
						<img
							className="w-full object-cover"
							src="https://res.cloudinary.com/dkezwrb3a/image/upload/v1689181150/furniturelo/service/Rectangle_10_1_ec0mn8.svg"
							alt=""
						/>
					</div>
				...
				<div className="flex gap-12 rounded-3xl border border-gray-300 p-8 shadow-lg">
					<div className="flex-1 overflow-hidden rounded-3xl">
						<img
							className="w-full object-cover"
							src="https://res.cloudinary.com/dkezwrb3a/image/upload/v1689181150/furniturelo/service/Rectangle_11_1_lpbtea.svg"
							alt=""
						/>
					</div>
				...
				<div className="flex flex-row-reverse gap-12 rounded-3xl border border-gray-300 p-8 shadow-lg">
					<div className="flex-1 overflow-hidden rounded-3xl">
						<img
							className="w-full object-cover"
							src="https://res.cloudinary.com/dkezwrb3a/image/upload/v1689181150/furniturelo/service/Rectangle_10_2_wlogfs.svg"
							alt=""
						/>
					</div>
				...
				<div className="flex gap-12 rounded-3xl border border-gray-300 p-8 shadow-lg">
					<div className="flex-1 overflow-hidden rounded-3xl">
						<img
							className="w-full object-cover"
							src="https://res.cloudinary.com/dkezwrb3a/image/upload/v1689181149/furniturelo/service/Rectangle_11_2_uemsh2.svg"
							alt=""
						/>
					</div>
				...
				<div className="flex flex-row-reverse gap-12 rounded-3xl border border-gray-300 p-8 shadow-lg">
					<div className="flex-1 overflow-hidden rounded-3xl">
						<img
							className="w-full object-cover"
							src="https://res.cloudinary.com/dkezwrb3a/image/upload/v1689181152/furniturelo/service/Rectangle_10_3_rj8kwt.svg"
							alt=""
						/>
					</div>
